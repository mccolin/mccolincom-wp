...
function twentyten_widgets_init() {
  ...
  /* Everywhere: Widget array below intro text on intro pages only */
	register_sidebar( array(
		'name' => __( 'Footer Navigation Widget Area', 'twentyten' ),
		'id' => 'footer-widget-area',
		'description' => __( 'Small widget area for navigation on all pages', 'twentyten' ),
	...
	/* Everywhere but home page: Widget array ahead of footer for small widgets */
	register_sidebar( array(
		'name' => __( 'Pre-Footer Widget Area', 'twentyten' ),
		'id' => 'pre-footer-widget-area',
		'description' => __( 'Widget space above footer navigation on most pages', 'twentyten' ),
		'before_widget' => '<div id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
